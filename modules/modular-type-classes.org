...
* Modular Type Classes (email to coq-study mailing list, 05-Mar-2013)
...
** Modular type classes show-stopper? (email to self, 08-Jul-2012)
...
** Orphan instances (email to self, 11-May-2012)
